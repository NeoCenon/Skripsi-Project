...
export default function ChangeProductDetail() {
    ...
    <div className="flex flex-col h-screen bg-white text-black font-[Poppins]">
      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 bg-white p-12">
          <h2 className="text-2xl font-semibold mb-12">Change Product Detail</h2>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-12">
              ...
              <span className="text-black text-base">Inverter</span>
            </div>

            {["Category", "Purchase Price", "Sale Price", "Total Items"].map((label, idx) => (
              <div key={idx} className="flex items-center gap-12">
                ...
                <input
                  type="text"
                  className="border-[2px] border-black rounded-[12px] h-[42px] px-6 text-black w-[400px] outline-none"
                />
              </div>
            ))}
          </div>

          <div className="mt-12 flex gap-6 w-[600px]">
            <button className="bg-[#E45858] text-black font-semibold px-10 py-2 rounded-full">
              Delete
            </button>
            <button className="bg-[#89E0F8] text-black font-semibold px-10 py-2 rounded-full">
              Update
            </button>
          </div>
        </div>
